  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join {organizationName} on GapCloud Agent</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              ...
              <strong>{organizationName}</strong> on GapCloud Agent. GapCloud Agent is a powerful,
            ...
            >
              ...
              an invitation to join {organizationName} on GapCloud Agent.
            </Text>
          </Section>
        </Container>
