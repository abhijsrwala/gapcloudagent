    ...
    >
      ...
      <div className="w-full flex flex-col gap-12 md:grid md:grid-cols-2 lg:grid-cols-3 md:grid-rows-1">
        ...
        >
          <BlogCard
            href="/blog/test"
            title="How to Build an Agent in 5 Steps with gapcloud.ai"
            description="Learn how to create a fully functional AI agent using gapcloud.ai's unified API and workflows."
