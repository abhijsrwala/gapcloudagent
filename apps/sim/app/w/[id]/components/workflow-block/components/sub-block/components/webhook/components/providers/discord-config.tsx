...
const examplePayload = JSON.stringify(
  {
    content: 'Hello from GapCloud Agent!',
  ...
  return (
    <div className="space-y-4">
      <ConfigSection title="Discord Appearance (Optional)">
        ...
        >
          <Input
            ...
            placeholder="GapCloud Agent Bot"
      ...
      <InstructionsSection title="Sending Messages to Discord (Outgoing via this URL)">
        <p>
          To send messages <i>to</i> Discord using the GapCloud Agent Webhook URL (above), make a POST
      ...
      <Alert>
        ...
        <AlertDescription>
          The GapCloud Agent Webhook URL allows sending messages <i>to</i> Discord. Treat it like a
