...
description: Learn how connections work in GapCloud Agent
---
...
Connections are the pathways that allow data to flow between blocks in your workflow. When you connect two blocks in GapCloud Agent, you're establishing a data flow relationship that defines how information passes from one block to another.
